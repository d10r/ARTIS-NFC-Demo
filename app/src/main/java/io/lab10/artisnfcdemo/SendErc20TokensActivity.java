...
import io.lab10.artisnfcdemo.adapter.UnitSpinnerAdapter;
import io.lab10.artisnfcdemo.ethereum.exceptions.InvalidEthereumAddressException;
import io.lab10.artisnfcdemo.ethereum.utils.Erc20Utils;
import io.lab10.artisnfcdemo.ethereum.utils.UriUtils;
import io.lab10.artisnfcdemo.qrcode.QrCodeScanner;
import io.lab10.artisnfcdemo.utils.InputErrorUtils;
...
public class SendErc20TokensActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String defaultContractAddr = pref.getBoolean(PREF_KEY_MAIN_NETWORK, true) ?
                DEFAULT_SIGMA1_ERC20_CONTRACT_ADDRESS : DEFAULT_TAU1_ERC20_CONTRACT_ADDRESS;
        final String savedContractAddress = pref.getString(PREF_KEY_ERC20_CONTRACT_ADDRESS, defaultContractAddr);
        contractAddress.setText(savedContractAddress.trim().isEmpty() ? defaultContractAddr : savedContractAddress);
        ...
        gasLimitTxt.setText(pref.getString(PREF_KEY_ERC20_GASLIMIT, DEFAULT_ERC20_GASLIMIT));
