...
import io.lab10.artisnfcdemo.ethereum.CoinfinityClient;
import io.lab10.artisnfcdemo.ethereum.bean.EthBalanceBean;
import io.lab10.artisnfcdemo.ethereum.bean.TransactionPriceBean;
...
import io.lab10.artisnfcdemo.qrcode.QrCodeGenerator;
import io.lab10.artisnfcdemo.utils.IsoTagWrapper;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateBalance() throws Exception {
        ...
        Log.d(TAG, String.format("reading native token balance finished: %s", balance.toString()));
    }
    ...
    protected void onResume() {
        ...
        // no price feed for ATS existing / needed atm
        /*
        new Thread(() -> {
...
//        Intent intent = new Intent(this, VotingActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            // this was moved over from UiUtils (code nomore shared across activities)
            case R.id.switch_network:
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setMessage(String.format(getString(R.string.ask_switch_network), strNetwork))
                        .setPositiveButton(R.string.yes, (dialog, which) -> {
                            SharedPreferences.Editor mEditor = prefs.edit();
                            mEditor.putBoolean(PREF_KEY_MAIN_NETWORK, !isMainNetwork).apply();
                            showToast(String.format(getString(R.string.switched_to), finalStrNetwork), this);
                            adjustUiToNetwork();
                        })
    ...
    // sets styles and labels matching the currently chosen network
    private void adjustUiToNetwork() {
        SharedPreferences prefs = getSharedPreferences(PREFERENCE_FILENAME, Context.MODE_PRIVATE);
        if (prefs.getBoolean(PREF_KEY_MAIN_NETWORK, true)) {
            toolbar.setBackgroundColor(getResources().getColor(R.color.colorSigma1));
            setTitle("ARTIS Σ1");
        } else {
            toolbar.setBackgroundColor(getResources().getColor(R.color.colorTau1));
            setTitle("ARTIS τ1");
        }
    }
}
