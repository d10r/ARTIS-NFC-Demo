...
public class SendTransactionActivity extends AppCompatActivity {
    ...
    public void onResume() {
        ...
        // set toolbar background color according to the currently selected network
        ...
        toolbar.setBackgroundColor(isMainNetwork ?
                getResources().getColor(R.color.colorSigma1)
                : getResources().getColor(R.color.colorTau1));
    }
