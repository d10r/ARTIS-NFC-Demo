package io.lab10.artisnfcdemo.ethereum.utils;
...
import static io.lab10.AppConstants.TESTNET_URI;
import static io.lab10.artisnfcdemo.ethereum.utils.TransactionSigner.GAS_LIMIT;
import static io.lab10.artisnfcdemo.ethereum.utils.TransactionSigner.GAS_PRICE;
...
public class Erc20UtilsTest {
    ...
    public void testSendErc20Tokens() throws Exception {
        ...
        final TransactionReceipt transactionReceipt = Erc20Utils.sendErc20Tokens(ERC_CONTRACT, isoDep, Numeric.toHexStringNoPrefixZeroPadded(TransactionSigner.credentials.getEcKeyPair().getPublicKey(), 128), TransactionSigner.credentials.getAddress(), "0x8720af26d1810ae8fca995002ad56175e4c97b23", new BigInteger("1"), GAS_PRICE, GAS_LIMIT, null, TESTNET_URI);
    ...
    public void testGetErc20Balance() throws Exception {
        final BigInteger erc20Balance = Erc20Utils.getErc20Balance(ERC_CONTRACT, TransactionSigner.credentials.getAddress(), TESTNET_URI);
